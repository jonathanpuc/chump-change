...
test('it should render ExpenseForm correctly with expense data', () => {
...
test('it should set amount if valid input', () => {
  const value = '23.50';
  const wrapper = shallow(<ExpenseForm />);
  wrapper
    .find('input')
...
test('it should not set amount if invalid input', () => {
  const value = '12.122';
  const wrapper = shallow(<ExpenseForm />);
  wrapper
    .find('input')
...
test('it should set calendar focus on change', () => {
  const focused = true;
  const wrapper = shallow(<ExpenseForm />);
